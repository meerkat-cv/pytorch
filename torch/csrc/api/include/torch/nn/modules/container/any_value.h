...
/// the object stored. yf225 TODO fix this comment: It is simplified in that it does not handle copying, as
...
class AnyValue {
 public:
  ...
  /// yf225 TODO fix this comment: Copy is disallowed, because we don't need it.
